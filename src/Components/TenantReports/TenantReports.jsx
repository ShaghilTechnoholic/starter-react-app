...
const TenantReports = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, status) =>
                <>
                    <span className={status.key === '2' ? 'tenant-report-in-active-bar' : 'tenant-report-active-bar'}><img src={status.key === '2' ? inActiveDot : dot} alt="" className='me-1' />Active</span>
                </>
        },
        {
