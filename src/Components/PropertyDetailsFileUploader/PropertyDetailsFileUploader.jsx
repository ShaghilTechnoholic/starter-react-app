...
const PropertyDetailsFileUploader = ({ handleChange, handleClick, name, types, addNote }) => {
    ...
    return (
        <>
            <div
                ...
                onDrop={handleDrop}
                className={` ${addNote ? 'file-uploader-notes' : 'property-details-file-uploader mt-3'} ${isDragging ? 'dragging' : ''}`}
            >
